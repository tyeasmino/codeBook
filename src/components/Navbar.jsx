      ...
      <nav className='flex justify-between items-center p-5 sm:px-8 md:px-10 xl:px-[50px] border-b'>
        ...
        <p onClick={()=>setDarkMode(!darkMode)} className=' cursor-pointer text-[25px]'>
          ...
          <Link to="cart/" className='relative'>
            <TiShoppingCart />
            <span className='absolute -right-3 -top-3 bg-red-500 w-[25px] h-[25px] text-[10px] text-white border-2 border-white rounded-full flex items-center justify-center'> { cartList.length } </span>
          </Link>
